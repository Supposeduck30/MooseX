 ...
 */
class TwoWheelLocalizer(val wheelRadius:Double = 48.0, private var leftPodName: String, private var rightPodName: String, private var leftPodResolution: Resolution, private var rightPodResolution: Resolution): LocalizerBase() {
    ...
    override fun update() {
        ...
        currentPosition = Pose(currentPosition.x + dForward * cos(thetaMid), currentPosition.y + dForward * sin(thetaMid), currentPosition.heading + dHeading)
